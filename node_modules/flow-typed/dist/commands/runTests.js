...
function testTypeDefinition(flowVer, testDirPath) {
  return new Promise(function (res) {
    var IS_WINDOWS = _node.os.type() === 'Windows_NT';

    var child = _node.child_process.exec([_node.path.join(BIN_DIR, 'flow-' + flowVer + (IS_WINDOWS ? '.exe' : '')), 'check', '--strip-root', '--all', testDirPath].join(' '));
      ...
      while (1) {
        switch (_context15.prev = _context15.next) {
          ...
          case 4:
            ...
            throw new Error("Trying to run ".concat(testGroup.id, ", but test dir already exists! ") + "Bailing out!");
